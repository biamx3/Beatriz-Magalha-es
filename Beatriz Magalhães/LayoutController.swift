...
//        self.blankButton = UIButton()
//        self.blankButton.frame = CGRectMake(0,600,self.imageView.frame.origin.x*4.6-10, 200)
//        self.blankButton.addTarget(self, action: "blankPressed:", forControlEvents: .TouchUpInside)
